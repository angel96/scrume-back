...
public class PopulatorDatabase implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Project project1 = repositoryProject.save(new Project("Proyecto 1", "aaaaa", team1));
		Project project2 = repositoryProject.save(new Project("Proyecto 2", "bbbbb", team1));
		Project project3 = repositoryProject.save(new Project("Proyecto 3", "ccccc", team2));
		Project project4 = repositoryProject.save(new Project("Proyecto 4", "ddddd", team2));
		Project project5 = repositoryProject.save(new Project("Proyecto 5", "eeeee", team2));
