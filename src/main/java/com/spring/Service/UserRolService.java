...
public class UserRolService extends AbstractService {
	...
	public void teamOut(Integer idTeam) throws Exception {
	...
	public void removeFromTeam(Integer idUser, Integer idTeam) throws Exception {
		User principal = this.userService.getUserByPrincipal();
	...
	public ChangeRolDto changeRol(Integer idUser, Integer idTeam, ChangeRolDto changeRolDto) throws Exception {
